...
OutputDir=.
OutputBaseFilename=Clinica Life Instalador v-3.0.0
SetupIconFile=C:\Users\laisf\Documents\ClinicaLifeApp\doctor.ico
DisableDirPage=no

[Files]
Source: "Clinica Life App v-3.0.0.exe"; DestDir: "{app}"; DestName : "Clinica Life App.exe"
...
[Icons]
Name: "{group}\doctor"; Filename: "{app}\Clinica Life.exe"; IconFilename: "C:\Users\laisf\Documents\ClinicaLifeApp\doctor.ico"
Name: "{group}\{cm:UninstallProgram,IconImage}"; Filename: "{uninstallexe}"; IconFilename: "C:\Users\laisf\Documents\ClinicaLifeApp\doctor.ico"
